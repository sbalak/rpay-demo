  ...
  ({ onClose, onOpen }, ref) => {
    ...
    const fetchSavedAddresses = useCallback(async () => {
      ...
      try {
        ...
        log.debug("LocationCheck.tsx/loadAddresses(): fetching addresses");
        ...
        log.error("LocationCheck.tsx/loadAddresses(): Error fetching saved addresses: " + error);
      } 
      finally {
    ...
    const checkLocationStatus = useCallback(async () => {
      ...
      try {
        ...
        log.error("LocationCheck.tsx/checkLocationStatus(): Error checking location status: " + error);
      } 
      finally {
    ...
    const handleContinuePress = async () => {
      if (Platform.OS === "web") {
        try {
          ...
          log.debug("LocationCheck.tsx/checkLocationStatus(): Web location: " + JSON.stringify(position));
          setLocality({
          ...
          log.error("LocationCheck.tsx/checkLocationStatus(): Web location error: " + error);
