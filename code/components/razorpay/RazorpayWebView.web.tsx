...
export default function RazorpayWebView() {
  ...
  async function handleSuccess(response: any) {
    ...
    try {
      ...
      log.error('RazorpayWebView.web.tsx/onPaymentSuccess(): Payment succeeded but confirmation failed: ' + e);
  ...
  async function handleCancel() {
    ...
    try {
      ...
      log.error('RazorpayWebView.web.tsx/onPaymentCancel(): Error cancelling order: ' + e);
  ...
  function openRazorpay() {
    ...
    const options = {
      ...
      modal: {
        ondismiss: function () {
          log.debug('RazorpayWebView.web.tsx/onMessage(): Payment cancelled by user');
          handleCancel();
        },
      },
