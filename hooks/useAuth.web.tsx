...
const AuthProvider: React.FC<Props> = ({ children }) => {
  ...
  useEffect(() => {
    const loadAccessToken = async () => {
      ...
      console.log("useAuth.web.tsx/useEffect(): Current CustomerId: " + userId);
      ...
      if (accessToken) {
        ...
        console.log("useAuth.web.tsx/useEffect(): Authenticated");
      } else {
        setAuthState({
          token: null,
          userId: null,
        ...
        console.log("useAuth.web.tsx/useEffect(): AccessToken Invalidated");
      }
    };
  ...
  const logout = async () => {
    try {
      ...
      console.log("useAuth.web.tsx/logout(): Logout Successful");
